...
public class ConstantsURL {
	...
	public final static String GETPROFILE = "/api/users/getProfile";
	
	public final static String FINDBYUSERNAME = "/api/users/findByUserName";
	
	public final static String HELLO = "/api/users/hello/{name}";
	
	public final static String GETPROFILESHOME = "/api/users/getProfilesHome";
	
	public final static String GETSEARCHHOME = "/api/users/getSearchHome";
	...
	public final static String SAVEPROFILE = "/api/profile/saveprofile";
	...
	public final static String SETUNLIKE = "/api/profile/setUnLike";
